...
pub const RECV_CAP: Endpoint = Endpoint::from(CapPtr::new(RECV_SLOT));
pub const ENDPOINT_CAP: Endpoint = Endpoint::from(CapPtr::new(ENDPOINT_SLOT));
pub const REPLY_CAP: Reply = Reply::from(CapPtr::new(REPLY_SLOT));
